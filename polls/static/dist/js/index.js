...
try {
  ...
  <script>
    // Lấy tất cả các nút thoát popup
    const closeButton = document.querySelectorAll('.popup-body__exit');

    // Lặp qua từng nút và thêm sự kiện "click" để đóng popup khi nhấn
